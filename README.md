...
| 3 | 🔴 Alta | 2 | Eu como gestor, quero unificar e padronizar todos os checklists e cadastros atualmente utilizados em ferramentas distintas em uma única plataforma | 5 | Centralização, padronização e unificação de checklists e cadastros | ❌ |
...
| 9 | 🟠 Média | 2 | Eu como cliente, quero acessar informações da parte comercial e operacional em um só ambiente para amplo acesso aos dados e com esses dados ter insights | 6 | Integração de dados comerciais e operacionais na mesma plataforma | ❌ |
| 10 | 🟠 Média | 2 | Eu como cliente, quero cadastrar agregados com devolutiva automática após a conclusão do processo de cadastro para facilitar o controle e acompanhamento dos cadastros | 6 | Cadastro de agregados com feedback automático | ❌ |
| 11 | 🟠 Média | 2 | Eu como cliente, quero poder calcular a cotação de um frete de forma automática para agilizar a criação de cotações e eliminar cálculos manuais | 4 | Cotação com cálculo automático de custos, valores e adicionais | ❌ |
| 12 | 🟠 Média | 3 | Eu como cliente, quero acessar informações da parte comercial e operacional em um só ambiente | ? | Integração de dados comerciais e operacionais na mesma plataforma | ❌ |
| 13 | 🟠 Média | 3 | Eu como gestor, quero eleger as permissões que cada liderado terá dentro do sistema, para controlar o nível de acesso conforme a função de cada colaborador | ? | Controle de permissões customizáveis por usuário | ❌ |
| 14 | 🟡 Baixa | 1 | Eu como comercial, quero agendar tarefas e configurar lembretes, afim de acompanhar próximos contatos com clientes | 6 | Sistema de agendamento e lembretes integrado ao cadastro e histórico de clientes | ✅ |
