...
| 12 | 🟠 Média | 3 | Eu como usuário, quero selecionar de onde estou fazendo login após autenticar, para que o administrativo tenha acesso às informações da origem/departamento específico | 5 | Tela de seleção de origem/departamento integrada ao fluxo de login | ❌ |
...
| 14 | 🟡 Baixa | 1 | Eu como comercial, quero agendar tarefas e configurar lembretes, para acompanhar os próximos contatos com clientes | 6 | Sistema de agendamento e lembretes integrado ao cadastro e histórico de clientes | ✅ |
| 15 | 🟡 Baixa | 1 | Eu como comercial, quero medir o rendimento e a taxa de conversão das visitas em vendas do setor comercial, para avaliar o desempenho dos vendedores | 6 | Relatórios de desempenho do setor comercial com indicadores de conversão e faturamento | ✅ |
...
| 17 | 🟡 Baixa | 3 | Eu como usuário, quero que a plataforma seja responsiva para mobile, para conseguir acessar e utilizar todas as funcionalidades pelo celular ou tablet | 4 | Responsividade da plataforma para dispositivos móveis | ❌ |
...
| 4 | 🟠 Média | 3 | Eu como usuário, quero selecionar de onde estou fazendo login após autenticar, para que o administrativo tenha acesso às informações da origem/departamento específico | 5 | Tela de seleção de origem/departamento integrada ao fluxo de login |
