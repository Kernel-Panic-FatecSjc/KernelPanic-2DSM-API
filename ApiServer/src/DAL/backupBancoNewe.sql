...
CREATE TABLE `ChecklistAgregado` (
  `check_agre_ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ChecklistFuncionario` (
  `check_func_ID` int(11) NOT NULL AUTO_INCREMENT,
  `tipo` varchar(30) NOT NULL,
  `respostas` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`respostas`)),
  `path_img` varchar(255) DEFAULT NULL,
...
CREATE TABLE `Cliente` (
  ...
  `segmento_atuacao` varchar(40) NOT NULL,
  `funcionario_ID` int(11) DEFAULT NULL,
  `funil_ID` int(11) DEFAULT NULL,
  PRIMARY KEY (`cliente_ID`),
  KEY `FK_70e132bf1f92bb6d009bb3bb810` (`funcionario_ID`),
  KEY `FK_b5873b13256f9258b1e3f8a8cc6` (`funil_ID`),
  CONSTRAINT `FK_70e132bf1f92bb6d009bb3bb810` FOREIGN KEY (`funcionario_ID`) REFERENCES `Funcionario` (`funcionario_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_b5873b13256f9258b1e3f8a8cc6` FOREIGN KEY (`funil_ID`) REFERENCES `Funil_vendas` (`funil_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
(2,'Empresa Beta','Av. Rio Branco, 200','Metalúrgia',3,4),
(7,'Empresa Alpha','Rua Alguma Coisa','Atuações',2,2),
(11,'Empresa Z','Rua da Empresa Y','Vendas',1,7),
(13,'Guarana Dolly','iuhiuhi','iuiniu',2,2);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER trg_after_cliente_update
...
CREATE TABLE `Contato_cliente` (
  `contato_cliente_ID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `FK_50cb9aaeca047b8fe653c9fad02` FOREIGN KEY (`cliente_ID`) REFERENCES `Cliente` (`cliente_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
(11,'celular','123456789010',7),
(22,'email','empresaY@email.com',11),
(23,'celular','123456767',13);
...
CREATE TABLE `Evento_treinamento` (
  ...
  `evento_link` longtext DEFAULT NULL,
  `status` varchar(20) NOT NULL,
  `organizador_ID` int(11) DEFAULT NULL,
  PRIMARY KEY (`evento_ID`),
  KEY `FK_7cfb9f5abe404e7c976eef9776f` (`organizador_ID`),
  CONSTRAINT `FK_7cfb9f5abe404e7c976eef9776f` FOREIGN KEY (`organizador_ID`) REFERENCES `Funcionario` (`funcionario_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `Evento_treinamento` VALUES
...
CREATE TABLE `Funcionario` (
  ...
  CONSTRAINT `FK_b13934bb9abdb7b2f4faef99ced` FOREIGN KEY (`gerente_ID`) REFERENCES `Funcionario` (`funcionario_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
(1,'Carlos Silva','Masculino','Rua A, 123','11999999999','Gerente de Vendas','carlos@empresa.com','$2b$10$MFzYXnHP3r4sURVJvahPvOGAaeFKDxlYDF.yvHF5VCAty8JLG5ZIi','São Paulo',NULL),
(2,'Ana Oliveira','Feminino','Rua B, 456','11888888888','Vendedor','ana@empresa.com','$2b$10$MFzYXnHP3r4sURVJvahPvOGAaeFKDxlYDF.yvHF5VCAty8JLG5ZIi','São Paulo',1),
(3,'João Souza','Masculino','Rua C, 789','11777777777','Consultor','joao@empresa.com','$2b$10$MFzYXnHP3r4sURVJvahPvOGAaeFKDxlYDF.yvHF5VCAty8JLG5ZIi','Rio de Janeiro',1);
...
CREATE TABLE `Funcionarios_convidados` (
  ...
  CONSTRAINT `FK_50bb6dbfc38b7c408dc0ebd1973` FOREIGN KEY (`evento_id`) REFERENCES `Evento_treinamento` (`evento_ID`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `FK_66f1d2b0d133bb6ddda6739a9fb` FOREIGN KEY (`funcionario_id`) REFERENCES `Funcionario` (`funcionario_ID`) ON DELETE CASCADE ON UPDATE NO ACTION
...
INSERT INTO `Funcionarios_convidados` VALUES
(2,1),
(3,1);
...
CREATE TABLE `Funil_vendas` (
  `funil_ID` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `Funil_vendas` VALUES
(1,'Prospeccao'),
(2,'Inicial'),
(3,'Potencial'),
(4,'Manutencao'),
...
CREATE TABLE `Historico_funil` (
  ...
  CONSTRAINT `FK_333d628457f18f33a1735cba62b` FOREIGN KEY (`funil_ID`) REFERENCES `Funil_vendas` (`funil_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_c3ff30955f7a883c410d1755583` FOREIGN KEY (`cliente_ID`) REFERENCES `Cliente` (`cliente_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `Historico_funil` VALUES
(2,'2025-10-23 01:27:51',2,2),
(4,'2025-10-26 23:33:12',2,6),
(13,'2025-10-26 23:34:56',2,3),
(16,'2025-10-26 23:34:59',2,1),
(21,'2025-10-26 23:35:06',2,4),
(22,'2025-10-26 23:39:37',7,2),
(23,'2025-10-26 23:39:51',2,7),
(24,'2025-10-26 23:39:57',2,6),
(25,'2025-10-26 23:40:01',7,5),
(26,'2025-10-26 23:41:04',2,2),
(27,'2025-10-26 23:41:05',2,6),
(28,'2025-10-26 23:41:06',2,2),
(29,'2025-10-26 23:41:07',2,6),
(30,'2025-10-26 23:41:07',2,2),
(32,'2025-10-26 23:59:46',11,7),
(33,'2025-10-26 23:59:47',11,3),
(34,'2025-10-26 23:59:51',11,6),
(35,'2025-10-26 23:59:52',11,7),
(36,'2025-10-26 23:59:53',11,8),
(37,'2025-10-27 01:12:50',2,6),
(38,'2025-10-27 01:12:51',7,2),
(39,'2025-10-27 01:12:52',11,7),
(40,'2025-10-27 01:24:13',7,3),
(41,'2025-10-27 01:24:14',11,2),
(42,'2025-10-27 16:17:47',2,7),
(43,'2025-10-27 16:18:13',11,6),
(44,'2025-10-27 16:18:14',7,8),
(45,'2025-10-27 16:18:15',2,4),
(46,'2025-10-27 16:18:15',7,3),
(47,'2025-10-27 16:18:16',11,3),
(48,'2025-10-27 16:18:17',7,7),
(49,'2025-10-28 11:44:52',7,2),
(50,'2025-10-28 11:44:53',11,6),
(51,'2025-10-28 11:46:10',11,7);
...
CREATE TABLE `Interacao_cliente` (
  ...
  CONSTRAINT `FK_67a8108793b88002a2bd16ac853` FOREIGN KEY (`cliente_ID`) REFERENCES `Cliente` (`cliente_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_cb34e5d245ba3c99e3a541d7ef9` FOREIGN KEY (`funcionario_ID`) REFERENCES `Funcionario` (`funcionario_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `Interacao_cliente` VALUES
(2,'2025-09-22','Chamada','Cliente não atendeu, reagendado.',3,2);
...
CREATE TABLE `Lembrete` (
  `lembrete_ID` int(11) NOT NULL AUTO_INCREMENT,
...
(1,'usuario@exemplo.com','Reunião','2025-10-27 13:20:00','Reunião');
...
CREATE TABLE `Notificacao` (
  ...
  `corpo_notificacao` longtext DEFAULT NULL,
  `evento_ID` int(11) DEFAULT NULL,
  PRIMARY KEY (`notificacao_ID`),
  KEY `FK_13bf01535d8fd63e3838b6b238d` (`evento_ID`),
  CONSTRAINT `FK_13bf01535d8fd63e3838b6b238d` FOREIGN KEY (`evento_ID`) REFERENCES `Evento_treinamento` (`evento_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Notificacao_convidados` (
  ...
  `status_leitura` tinyint(4) NOT NULL,
  ...
  CONSTRAINT `FK_2db1f5eae0532a74fe60d60dae8` FOREIGN KEY (`funcionario_ID`, `evento_ID`) REFERENCES `Funcionarios_convidados` (`funcionario_id`, `evento_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_bf5c5fca40a401d990ae8a2a3e8` FOREIGN KEY (`notificacao_ID`) REFERENCES `Notificacao` (`notificacao_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Notificacao_convidados` VALUES
(2,1,1,1,'2025-09-24 13:00:00','Alta'),
(3,1,1,0,NULL,'Alta');
...
(2,'vendedor','Pode cadastrar e gerenciar clientes'),
(3,'gestor','Acesso intermediario entre master e vendedor');
...
CREATE TABLE `Presenca` (
  ...
  `razao_recusa` longtext DEFAULT NULL,
  `data_termino` timestamp NULL DEFAULT NULL,
  `link_feedback` longtext DEFAULT NULL,
  `funcionario_ID` int(11) DEFAULT NULL,
  `evento_ID` int(11) DEFAULT NULL,
  PRIMARY KEY (`presenca_ID`),
  KEY `FK_2769263adcec6e12e8a8950376b` (`funcionario_ID`,`evento_ID`),
  CONSTRAINT `FK_2769263adcec6e12e8a8950376b` FOREIGN KEY (`funcionario_ID`, `evento_ID`) REFERENCES `Funcionarios_convidados` (`funcionario_id`, `evento_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,1,NULL,'2025-09-25 16:00:00','https://evento.com/feedback1',2,1),
(2,0,'Conflito de agenda',NULL,NULL,3,1);
...
CREATE TABLE `Vendas` (
  ...
  CONSTRAINT `FK_acdcb804cd337af00d52ff4b4bd` FOREIGN KEY (`cliente_ID`) REFERENCES `Cliente` (`cliente_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_c3a06704616da020d157ed7ce8d` FOREIGN KEY (`funcionario_ID`) REFERENCES `Funcionario` (`funcionario_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(2,'2025-09-16 03:00:00',3200.00,'Manutencao',2,3);
...
CREATE TABLE `funcionario_perfis` (
  ...
  CONSTRAINT `FK_97b28c5818288522846585bceb5` FOREIGN KEY (`perfil_ID`) REFERENCES `Perfil` (`perfil_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `funcionario_perfis` VALUES
(1,1),
(2,3),
(3,3);
...
(1,1761182139716,'PrimeiraMigration1761182139716'),
(2,1978901234567,'CreateClienteTrigger1978901234567');
...
-- Dump completed on 2025-11-15 13:05:40
